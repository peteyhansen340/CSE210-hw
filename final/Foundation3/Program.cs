...
class Program
{
    static void Main(string[] args)
    {
        ...
        Lectures lecture = new Lectures("Stake Conference", "Church meeting with members of the Almada Stake.", "April 5, 2024", "10:00 am - 12:00 pm", $"{lectureAddress}", "Lecture", "Elder Pokhylko", 400);
        ...
        Receptions reception = new Receptions("Marta and Renato", "Marta and Renato's wedding ceremony and reception", "September 2, 2024", "4:00 pm - 12:00am", $"{receptionAddress}", "Reception", "mandr@gmail.com");
        ...
        Outdoor outdoor = new Outdoor("YM & YM Activity", "Sports night at the park for all youth.", "June 28, 2024", "6:00 pm", $"{outdoorAddress}", "Outdoor", "Sunny");
